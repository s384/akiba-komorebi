...
namespace WallpaperCreator.OnScreen {
    ...
    public class FinalPage : Box {
        ...
        Image logo = new Image.from_file("/usr/share/komorebi/Resources/Komorebi/done.svg");
        ...
        public FinalPage() {
            ...
            var mv_command = @"sudo mv $(Environment.get_home_dir())/$(wallpaperName.replace(" ", "_").replace(".", "_").down()) /usr/share/komorebi/Resources/Komorebi";
