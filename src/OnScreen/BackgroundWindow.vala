		...
		void setWallpaper() {
			...
			if(enableVideoWallpapers) {
				...
				if(wallpaperType == "video") {
					...
					var videoPath = @"file:///usr/share/komorebi/Resources/Komorebi/$wallpaperName/$videoFileName";
			...
			wallpaperPixbuf = new Gdk.Pixbuf.from_file_at_scale(@"/usr/share/komorebi/Resources/Komorebi/$wallpaperName/wallpaper.jpg",
