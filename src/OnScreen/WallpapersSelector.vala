...
namespace Komorebi.OnScreen {
	...
	public class WallpapersSelector : ScrolledWindow {
		...
		public string path = "/usr/share/komorebi/Resources/Komorebi/";
		...
		public void getWallpapers () {
			...
			File wallpapersFolder = File.new_for_path("/usr/share/komorebi/Resources/Komorebi");
			...
			try {
				...
				print("Could not read directory '/usr/share/komorebi/Resources/Komorebi/'");
			}
		}
