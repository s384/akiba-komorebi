...
namespace Komorebi.OnScreen {
	...
	private class Thumbnail : EventBox {
		...
		Image borderImage = new Image.from_file("/usr/share/komorebi/Resources/Komorebi/thumbnail_border.svg");
		...
		public Thumbnail.Add() {
			...
			thumbnailImage.pixbuf = new Gdk.Pixbuf.from_file_at_scale("/usr/share/komorebi/Resources/Komorebi/thumbnail_add.svg", 150, 100, false);
