...
namespace Komorebi.Utilities {
	...
	public void readConfigurationFile () {
		...
		// Default values
		wallpaperName = "Figure_introduction_ESP";
		timeTwentyFour = true;
	...
	void readWallpaperFile () {
		...
		var wallpaperPath = @"/usr/share/komorebi/Resources/Komorebi/$wallpaperName";
		...
		if(wallpaperName == null || !File.new_for_path(wallpaperPath).query_exists() ||
			...
			wallpaperName = "Figure_introduction_ESP";
			wallpaperPath = @"/usr/share/komorebi/Resources/Komorebi/$wallpaperName";
		...
		var wallpaperJpgPath = @"/usr/share/komorebi/Resources/Komorebi/$wallpaperName/wallpaper.jpg";
